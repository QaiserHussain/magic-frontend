...
import LandingIllustration from "../assets/illustations/banner.gif";
    ...
    <div className="">
          ...
          <div className="w-12/12 md:w-6/12">
            <div className="flex items-center">
              <img
                ...
                alt="landing"
              />
              <h1 className="text-2xl font-thin text-slate-800">MagicQuiz</h1>
            </div>
            <h2 className="text-4xl font-medium mt-2 text-slate-600">
              MagicQuiz Builder and Assessment Tool
            </h2>
            <p className="w-10/12 mt-4 text-slate-600 font-medium text-2xl">
              Using Magic-Quiz, it’s super fast and easy to create a quiz - perfect
      ...
      {!isError && (
        <div
          ...
          className="border-b-2 border-blue-500 shadow-large mx-auto my-5 py-5 md:mt-0 items-center justify-items-center grid max-w-screen-xl"
        >
          <div >
            <h2 className="text-4xl md:text-7xl text-center text-slate-600 font-thin">
              {data?.users}+
            </h2>
            <p className="text-center text-sm md:text-sm font-medium">Users</p>
          </div>
      ...
      <div className="my-20 max-w-screen-xl mx-5 md:mx-auto">
        ...
        <div style={{ gap: 20 }} className="grid mt-10 grid-use-app">
          {AppUseData.map((useData) => (
            <div
              className="flex flex-col px-4 py-7 items-center justify-center shadow-small rounded-md"
              key={useData.id}
            >
      ...
      {/* // add new component */}
        ...
        <div className="my-20 max-w-screen-xl mx-5 md:mx-auto flex flex-wrap md:flex-nowrap items-center justify-between">
          ...
          <p className="w-full md:w-10/12 ml-0 md:ml-4 text-2xl">
            ...
            papers. Users can complete your paperless quiz via Magic-Quiz.
          </p>
        </div>
