...
export const useGenerateQuiz = (options?: MutationOptions) => MutationFactory('Generate Quiz', endpoints.generate, 'POST', options)
export const useGenQuiz = (url: string, queryKey: QueryKey, options?: UseQueryOptions<any, AxiosError, any>) => QueryFactory(queryKey, url, options);
// export const useQuizByTag = ()=> QueryFactory()